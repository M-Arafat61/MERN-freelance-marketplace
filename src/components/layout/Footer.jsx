const Footer = () => {
  return (
    <div className='max-w-7xl  m-auto my-8 md:my-10 p-2 lg:my-16 '>
      <footer className=' flex flex-col md:flex-row items-start flex-grow text-base-content justify-between'>
